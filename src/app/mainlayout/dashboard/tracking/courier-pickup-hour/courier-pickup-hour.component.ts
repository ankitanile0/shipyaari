...
@Component({
  selector: 'app-courier-pickup-hour',
  templateUrl: './courier-pickup-hour.component.html',
  styleUrls: ['./courier-pickup-hour.component.css']
})
export class CourierPickupHourComponent implements OnInit {

   @Input() courier_wise_pickup_hours_graph: any;
...
Loader: string;
 ...
 ngOnInit(): void {
    ...
    this.prepare_data(this.courier_wise_pickup_hours_graph);
  }
