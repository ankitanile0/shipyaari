...
@Component({
  selector: 'app-delivry-analysis',
  templateUrl: './delivry-analysis.component.html',
  styleUrls: ['./delivry-analysis.component.css']
})
export class DelivryAnalysisComponent implements OnInit {

   @Input() delivery_analysis_graph: any;
 ...
 ngOnInit(): void {
    ...
    this.prepare_data(this.delivery_analysis_graph);
  }
