...
export class CourierDeliveryComponent implements OnInit {

   @Input() courier_wise_delivery_days_graph: any;
 ...
 ngOnInit(): void {
    ...
    this.prepare_data(this.courier_wise_delivery_days_graph);
